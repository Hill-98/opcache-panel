export default {
    ...
    page: {
        ...
        advanced: {
            file_path: "文件路径",
            dir_path: "目录路径",
            dir_file_path: "目录/文件路径",
            multi_path: "多个路径用 | 分割",
            clear_history: "清除历史",
            submit: "提交",
            pre_cache: "预缓存文件",
            pre_cache_summary: "将指定文件编译为字节码缓存，如果路径指向目录 (路径以 '/' 结束)，则编译整个目录下所有的 PHP 文件。 (支持 glob 匹配)",
            invalidate_cache_dir: "废除缓存 (目录)",
            invalidate_cache_dir_summary: "使指定目录下所有 PHP 文件的缓存无效 (支持 glob 匹配)",
            check_cache: "检查文件缓存",
